...
from diffusers.schedulers import DDIMScheduler, LMSDiscreteScheduler, PNDMScheduler, EulerDiscreteScheduler, EulerAncestralDiscreteScheduler, DPMSolverMultistepScheduler
...
class StableDiffusionImg2Img4VideoPipeline(DiffusionPipeline):
    r"""
    ...
    def prepare_latents(self, image, timestep, batch_size, num_images_per_prompt, dtype, device, noise, generator=None):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latents = self.prepare_latents(
            image, latent_timestep, batch_size, num_images_per_prompt, text_embeddings.dtype, device, noise, generator
        )
